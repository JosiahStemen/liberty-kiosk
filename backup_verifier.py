...
class BackupVerifier(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.result_text = tk.Text(self, height=22, font=("Consolas", 10), bg="#002b4d", fg="white", wrap="word")
    ...
    def verify_selected(self):
        ...
        self.result_text.insert(tk.END, "=== BACKUP VERIFICATION REPORT ===\n\n")
        ...
        if current_hash == stored_hash:
            ...
            self.result_text.insert(tk.END, "The backup is 100% untouched and authentic.\n")
            self.result_text.insert(tk.END, "This provides strong cryptographic proof of integrity.\n")
            self.result_text.insert(tk.END, "You can confidently present this to your CO or legal personnel.")
        else:
            self.result_text.insert(tk.END, "❌ VERIFICATION FAILED - FILE WAS MODIFIED\n", "red")
